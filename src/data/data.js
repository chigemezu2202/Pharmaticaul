...
import sneakershoe from "../assets/sneaker.jpg";
...
import psale1 from "../assets/nike-air-red.jpg";
import psale2 from "../assets/nike-adapt-bb.jpg";
import psale3 from "../assets/nike-adapt-bb-smart.jpg";
...
const heroapi = {
  title: "Buy Your Favourite Batana ",
  subtitle: "Adapt 2.0 Med",
  img: heroimg,
...
const highlight = {
  heading: "HIGHLIGHTS",
  title: "Batana AIR WITH LIMITLESS CHOICES",
...
const sneaker = {
  heading: "FEATURED",
  title: "Med  At Low Cheap Price",
  text: "The radiance lives on Batana Sneakers Air Lancing Shoe s, the basket ball OG that puts a fresh spin on what you know best: durably stitched overlays, clean finishes and the perfect amount of flash to make you shine.",
  btn: "Explore More",
